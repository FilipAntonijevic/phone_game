...
6. **Power-ups** (each has its own fill meter; score gains fill all meters; casting resets that meter to 0 — score is not spent)
   - **Hint**: highlight a scoring pair (fills at **40**)
   - **−1 ×5**: decrease 5 random circles by 1 (fills at **30**)
   - **Blast**: destroy the next circle you tap (fills at **20**)
